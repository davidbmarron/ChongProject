...
if (isset($_SESSION['user'])) {
    ...
    $query = "SELECT p.*
              ...
              WHERE u.UserID = '$userID'"; // corrected variable name and removed single quotes
    ...
    <ul>
        ...
        if ($result) {
            while ($row = $result->fetch_assoc()) {
                ...
                $BookingID = $row['BookingID']; // Corrected from 'UserID'
                $Amount = $row['Amount'];
                $DateOfPayment = $row['DateOfPayment'];
                $PaymentMethod = $row['PaymentMethod'];
                echo "<li>PaymentID: $PaymentID | BookingID: $BookingID | Amount: $Amount | Date of Payment: $DateOfPayment | Payment Method: $PaymentMethod</li>";
            }
        }
        ?>
    </ul>
